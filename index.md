...
<div class="relative isolate overflow-hidden pt-[120px] md:pt-[100px] min-h-screen" id="hero">
    ...
    <div class="absolute inset-0 -z-5 bg-gradient-to-b from-slate-900/90 via-slate-900/30 to-black"></div>
    
    <div class="mx-auto max-w-7xl px-6 lg:px-8 flex items-center justify-center min-h-screen">
        <div class="mx-auto max-w-4xl text-center relative z-50">
            <h1 class="font-orbitron text-6xl font-black tracking-tight text-balance text-white sm:text-7xl lg:text-8xl xl:text-9xl relative z-50" style="text-shadow: 4px 4px 8px rgba(0,0,0,0.9), 2px 2px 4px rgba(0,0,0,0.8); color: white !important; display: block !important;">
                <span class="inline-block relative z-50" style="color: white !important;">
                    Cabin Time
            ...
            <h2 class="mt-8 text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-black text-white font-orbitron tracking-wide relative z-50" style="text-shadow: 4px 4px 8px rgba(0,0,0,0.9), 2px 2px 4px rgba(0,0,0,0.8); color: white !important; display: block !important;">
                通信断絶の空間に観光のナビゲーションを
            </h2>
            <p class="mt-8 text-xl font-bold text-white sm:text-2xl/8 relative z-50" style="text-shadow: 3px 3px 6px rgba(0,0,0,0.9), 1px 1px 3px rgba(0,0,0,0.8); color: white !important; display: block !important;">
                移動時間の価値最大化プラットフォーム
            </p>
            <div class="mt-12 flex items-center justify-center gap-x-6 relative z-50">
