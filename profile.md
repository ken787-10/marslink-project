    ...
    <div class="container px-5 py-24 mx-auto">
        ...
        <div class="w-full bg-gray-300 rounded-lg overflow-hidden p-10 flex items-end justify-start relative h-96">
            <iframe 
                ...
                marginwidth="0" 
                scrolling="no" 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3279.920643!2d135.4959841!3d34.702471!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6000e68ecc7a58c9%3A0x4b5d4f8c5a2b1d9e!2z44CSNTI5LTAwMTEg5aSn6Ziq5bqc5aSn6Ziq5biC5YyX5Yy65aSn5rex55S6Nuw4uk0z44Oo5Y-377yYIOOCsOODqeODs-OCsOODquODvOODs-Wkp-mYquWMl-mkqA!5e0!3m2!1sja!2sjp!4v1647834567890!5m2!1sja!2sjp">
            </iframe>
            <div class="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md">
                <div class="lg:w-1/2 px-6">
                    <h2 class="title-font font-semibold text-white tracking-widest text-xs font-orbitron">ADDRESS</h2>
                    <p class="mt-1 text-gray-300">
                        〒530-0011<br>
                        大阪市北区大深町6番38号<br>
                        グラングリーン大阪北館<br>
                        JAM BASE 6階 JAM-DESK
                    </p>
                </div>
                <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
                    <h2 class="title-font font-semibold text-white tracking-widest text-xs font-orbitron">ACCESS</h2>
                    <p class="text-cyan-400 leading-relaxed">JR大阪駅直結</p>
                    <h2 class="title-font font-semibold text-white tracking-widest text-xs mt-4 font-orbitron">EMAIL</h2>
                    <a class="text-cyan-400 leading-relaxed" href="mailto:info@marslink.co.jp">info@marslink.co.jp</a>
                </div>
            </div>
        </div>
    </div>
...
<section class="text-gray-400 bg-black body-font">
    <div class="container px-5 py-24 mx-auto">
        <div class="text-center mb-20">
            <h2 class="text-xs text-cyan-400 tracking-widest font-medium title-font mb-1 font-orbitron">BUSINESS DOMAIN</h2>
            <h1 class="sm:text-3xl text-2xl font-medium text-center title-font text-white mb-4 font-orbitron">事業ドメイン</h1>
            <p class="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto">MarsLinkは以下の領域をコアに、移動×メディアのイノベーションを推進しています。</p>
        </div>
        <div class="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
            <div class="p-2 sm:w-1/2 w-full">
                <div class="bg-gray-800 rounded flex p-4 h-full items-center">
                    ...
                    <span class="title-font font-medium text-white">機内・船内・車内・ホテルの空間をメディア化する観光DX</span>
                </div>
            </div>
            <div class="p-2 sm:w-1/2 w-full">
                <div class="bg-gray-800 rounded flex p-4 h-full items-center">
                    ...
                    <span class="title-font font-medium text-white">広告マネジメント・運用最適化</span>
                </div>
            </div>
            <div class="p-2 sm:w-1/2 w-full">
                <div class="bg-gray-800 rounded flex p-4 h-full items-center">
