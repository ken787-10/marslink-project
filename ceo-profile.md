...
<div class="bg-black min-h-screen w-full">
  ...
  <div class="relative isolate overflow-hidden bg-black px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div class="mx-auto max-w-4xl text-center">
      ...
      <p class="mt-8 text-base font-medium text-pretty text-white sm:text-lg/8">
        ...
        8年間にわたる議会活動と行政改革の現場で培った実行力、16ヵ国・地域における国際的視野をもとに、テクノロジーと社会課題の架け橋として、新たな移動の未来を切り拓く。
      </p>
    </div>
  </div>
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:max-w-none">
        <div class="text-center">
          ...
          <p class="mt-4 text-lg/8 text-gray-300">8年間の政治家経験と16ヵ国・地域での国際経験を基盤に、1000社を超える組織の成長を支援</p>
        </div>
  ...
  <div class="bg-black py-24 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:text-center">
        ...
        <p class="mt-6 text-lg/8 text-gray-300">政治家から起業家への転身により培われた多面的な専門性と、16ヵ国・地域での国際経験を基盤とした戦略的リーダーシップをご紹介します。</p>
      </div>
  ...
  <section class="bg-black dark:bg-gray-900">
    <div class="container px-6 py-10 mx-auto">
      ...
      <!-- Key Achievements -->
      <div class="mt-16">
        <h2 class="text-2xl font-semibold text-white text-center mb-12">Key Achievements</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div class="text-center">
            ...
            <h3 class="text-lg font-semibold text-white mb-2">米国国務省IVLP修了</h3>
            <p class="text-gray-400 text-sm">国際的な政治・経済リーダーシップ育成プログラム</p>
          </div>
          ...
          <div class="text-center">
            ...
            <h3 class="text-lg font-semibold text-white mb-2">シリコンバレー120社視察</h3>
            <p class="text-gray-400 text-sm">先進テクノロジー企業の詳細リサーチ</p>
          </div>

          <div class="text-center">
            <div class="w-16 h-16 mx-auto mb-4 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9.5a2 2 0 00-2-2h-2m-4-3v8m4-4v4m-4-4a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2h-2z" />
              </svg>
            </div>
            <h3 class="text-lg font-semibold text-white mb-2">国際会議・大使館講演</h3>
            <p class="text-gray-400 text-sm">米国大使館基調講演「シリコンバレーに学ぶ起業マインドセット」他</p>
          </div>
          ...
          <div class="text-center">
            ...
            <h3 class="text-lg font-semibold text-white mb-2">多頻度の海外出張</h3>
            <p class="text-gray-400 text-sm">高頻度国際移動による海外の最新動向の継続的把握</p>
          </div>
        </div>
      </div>
    </div>
